...
wget https://download.java.net/java/GA/jdk11/9/GPL/openjdk-11.0.2_linux-x64_bin.tar.gz -P files/pkg
...
wget https://github.com/sbt/sbt/releases/download/v1.7.1/sbt-1.7.1.tgz -P files/pkg

# get required files from an ssh server
